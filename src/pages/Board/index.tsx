...
export const Board: React.FC = () => {
    ...
    return (
        <BoardContext.Provider
            value={{ data, setData, oriPos, style, setStyle, currentCom, setIndex, show, setShow, setTxtDom, checkTxt }}
        >
            <div className="draw-containt" ref={editorMain}>
                <div
                    className="drawing-wrap"
                    style={{ width: wh.width * proportion + 'px', height: wh.height * proportion + 'px' }}
                    ref={editor}
                    onMouseDown={onMouseDown.bind(this, 'none')}
                    onMouseUp={onMouseUp}
                    ...
                    {show ? (
                        ...
                        >
                            ...
                            <div
                                ...
                                onMouseDown={onMouseDown.bind(this, 'rotate')}
                            ></div>
                        </div>
                    ) : null}
                </div>
