...
export const Right: React.FC = () => {
    const { index, data, setData, setWh, wh, setShowModal, editorMain, setModalType, proportion, setProportion } =
        useContext(Context);
        ...
        <div className="operation">
            {item ? (
                    ...
                    <ul className="operation-list">
                        ...
                        {item.color ? (
                            <li>
                                ...
                                <div
                                    className="colorBack"
                                    onClick={checkColorChange}
                                    style={{ background: item.color }}
                                ></div>
                                {visibility ? (
                                    <Color position={{ top: '33px', right: '0px' }} colorChange={getColor} />
                                ) : (
                                    ''
                                )}
                            </li>
                ...
                <div>
                    ...
                    <div onClick={getLength} className="lengthTrue">
                        确定
                    </div>
                </div>
            )}
